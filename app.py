...
# MODELO INDUSTRIAL FIJO: Ultra-estable, rápido y libre de depreciaciones de servidor
...
def buscar_fichas(consulta, historial):
    ...
    contexto_final = ""
    # CORRECCIÓN MAESTRA: Forzamos a Python a ordenar apuntando al índice [0] (los puntos de coincidencia numéricos)
